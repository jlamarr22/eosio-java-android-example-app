...
public class AbiProviderImplTest implements IABIProvider {

    private @NotNull IRPCProvider rpcProvider;
    private @NotNull ISerializationProviderTest serializationProvider;
     ...
     */
    public AbiProviderImplTest(@NotNull IRPCProvider rpcProvider,
