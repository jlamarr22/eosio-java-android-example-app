 ...
 */
public class EosioJavaRpcProviderImplTest implements IRPCProvider {
    ...
    @NotNull
    private IEosioJavaRpcProviderApiTest rpcProviderApi;
     ...
     */
    public EosioJavaRpcProviderImplTest(@NotNull String baseURL) throws EosioJavaRpcProviderInitializerError {
        this(baseURL, false);
    }
     ...
     * @throws EosioJavaRpcProviderInitializerError thrown if the base URL passed in is null.
     */
    public EosioJavaRpcProviderImplTest(@NotNull String baseURL, boolean enableDebug) throws EosioJavaRpcProviderInitializerError {
        ...
        this.rpcProviderApi = this.retrofit.create(IEosioJavaRpcProviderApiTest.class);
    }
    ...
    @Override
    public @NotNull PushTransactionResponse pushTransaction(PushTransactionRequest pushTransactionRequest) throws PushTransactionRpcError {
        return null;
    }
    ...
    public @NotNull PushTransactionResponse pushTransaction(
            PushTransactionRequestTest pushTransactionRequest) throws PushTransactionRpcError {
        try {
