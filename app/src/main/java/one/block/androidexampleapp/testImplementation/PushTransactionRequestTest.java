...
/**
 * The request of PushTransactionRequest RPC call {@link one.block.eosiojava.interfaces.IRPCProvider#pushTransaction(one.block.eosiojava.models.rpcProvider.request.PushTransactionRequest)}
 */
public class PushTransactionRequestTest {
